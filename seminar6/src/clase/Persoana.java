...
public class Persoana implements IPersoana{
	...
	public boolean checkCNP(){
		...
		if(CNP==null) {
			throw new ExceptieCNPNull("CNP null");
		}
		if(CNP.startsWith("0")) {
			throw new ExceptiePrimaCifra("CNP-ul incepe cu cifra 0");
		}
		if(CNP.length()!=13)
			throw new ExceptieWrongFormat("CNP-ul nu are lungimea corecta");
		...
		{
			throw new ExceptieLitereCNP("CNP-ul contine caractere incorecte");
		}
